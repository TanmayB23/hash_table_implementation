...
#define TABLE_SIZE 20029  //prime number larger than 20,000 is used so we get a more evenly distributed hash table
...
unsigned int Hash (string name)   //given hash funtion gives values between 0 and 20029
{
    const unsigned int prime = 100003;  // A prime number
...
int main()
{
    ...
    ifstream my_file;
    my_file.open("database.csv");     //opening the csv file
